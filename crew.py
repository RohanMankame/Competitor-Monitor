...
def run_competitor_analysis(product_name: str, target_domains: list, internal_price: float, currency: str) -> str:
    """
    ...
    analysis_task = create_analysis_task(strategist, internal_price, currency)
